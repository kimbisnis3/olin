...
class Po2 extends CI_Controller {
    ...
    public $indexpage   = 'po_agen2/v_po_agen2';
    public $printpage   = 'po_agen2/p_po_agen2';
    ...
    public function savedata()
    {
        ...
        if ($this->input->post('ref_kirim') == 'GX0002') {
            ...
            $a['lokasidari']    = $this->input->post('mask-provinsi').' - '.$this->input->post('mask-city').' - '.$this->input->post('mask-dist');
            $a['lokasike']      = $this->input->post('mask-provinsito').' - '.$this->input->post('mask-cityto').' - '.$this->input->post('mask-distto');
