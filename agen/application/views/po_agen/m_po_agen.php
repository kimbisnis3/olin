              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <label style="visibility: hidden;">xxxx</label>
                      <button type="button" class="btn btn-flat btn-biru" id="btn-tambah-barang" onclick="loadpesanan()"><i class="fa fa-circle-o"></i> Muat Pesananan</button>
                    </div>
                  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="box">
            ...
            <div class="box-body pad">
              <div class="table-responsive mailbox-messages">
                <table id="table-pesanan" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th width="5%">No</th>
                      <th>ID</th>
