...
<html>
                  ...
                  <form id="form-data">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <label>Produk</label>
                          <select class="form-control select2" name="ref_brg">
                          <option value=""></option>
  ...
  var path = 'mpromodiskon';
  var title = 'Master Promo Diskon';
  var grupmenu = '';
  ...
  $(document).ready(function() {
      select2();
      activemenux('masterdata', 'masterpromodiskon');
      ...
      table = $('#table').DataTable({
          ...
          "columns": [
            ...
            { "data": "customer_nama" },
            { "data": "barang_nama" },
            { "render" : (data,type,row,meta) => { return `${numeral(row.nominal).format('0,0')}` }},
            { "data": "minorder" },
            { "data": "ket" },
          ]
      });
