                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama_access">
                        </div>
                      </div>
                    </div>
                  </form>
  ...
  function edit_data() {
      ...
      $.ajax({
          ...
          success: function(data) {
              $('[name="id_access"]').val(data.id_access);
              $('[name="nama_access"]').val(data.nama_access);
              $('#modal-data').modal('show');
